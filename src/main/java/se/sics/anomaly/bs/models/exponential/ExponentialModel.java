 ...
 */
public class ExponentialModel extends Model<ExponentialValue> {
    private static final double prior_c = 0.0;
    private History<ExponentialValue> hist;

    public ExponentialModel(History<ExponentialValue> hist){
        this.hist = hist;
    }
    ...
    @Override
    public void addWindow(ExponentialValue v) {
        hist.addWindow(v);
    }
