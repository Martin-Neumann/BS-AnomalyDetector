 ...
 */
public class PoissonMicroModelCount implements Serializable{
    ...
    PoissonMicroModelCount(double elementCount, double historySize, int maxHistorySize){
    ...
    PoissonMicroModelCount(int maxHistorySize){
    ...
    public void addWindow(double elementCount, double windowSize){
        if(histCount+1 > maxHistorySize){
            this.count = count*1/(double)maxHistorySize;
            this.size = size*1/(double)maxHistorySize;
        }
        this.count += elementCount;
